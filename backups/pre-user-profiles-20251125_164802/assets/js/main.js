...
// API Base URL - use nginx proxy endpoint for dynamic data from database
const API_BASE_URL = window.location.pathname.includes('/lateral-entry/') 
    ? '/lateral-entry/api'  // Use nginx proxy to Flask API
...
function createEntrantCard(entrant) {
    ...
    let positionClass = 'text-sm text-blue-600 font-medium';
            ...
            <div class="p-5">
                <div class="flex items-start justify-between mb-3">
                    <div>
                        ...
                        <p class="${positionBadgeClass || positionClass}">${entrant.position}</p>
                    </div>
